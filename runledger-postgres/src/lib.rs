...
pub mod prelude {
    ...
    pub use crate::jobs::{
        ...
        JobRequeueStatePolicy, JobRunningUpdate, JobRuntimeConfigListFilter,
        JobRuntimeConfigRecord, JobRuntimeConfigUpsert, JobScheduleRecord, JobScheduleUpsert,
        JobScope, JobSuccessCompletionOutcome, NonRequeueableJobStatusError,
        ReapExpiredLeaseCleanupError, ReapExpiredLeaseCleanupOperation,
